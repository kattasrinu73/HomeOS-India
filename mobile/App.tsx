  ...
  const renderCustomerScreen = () => {
    ...
    return (
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <SectionTitle title="Your home" />
        <View style={styles.panel}><Row icon="home-outline" title="Home setup" detail="Address, home type, and appliances" onPress={() => setOnboardingVisible(true)} /><View style={styles.panelLine} /><Row icon="location-outline" title="Service location" detail={locationLabel} onPress={useLocation} /></View>
