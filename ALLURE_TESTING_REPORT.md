...
| Server workflow tests        | `pnpm test`                                       | Passed | **43 tests** across four files passed, including protected quote, OTP, manual dispatch, manual-radius guidance, operator assignment, itemised pricing review, cancellation audit, AI assessment, invoice/warranty, Home Health Score, and authorization behavior. |
...
> **Interpretation:** The automated suite currently contains **51 passing tests** in total: 43 in the web/server project and 8 in the Expo project. The result does not constitute physical-device or payment-provider certification.
